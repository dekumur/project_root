...
<div class="page-wrap">
  ...
  <p style="text-align:center;">Полезные статьи и видео для повышения финансовой грамотности взрослых.</p>
  ...
  <div class="content-grid">
    <div class="block">
      ...
      <?php if (mysqli_num_rows($articles) > 0): ?>
        ...
        <?php endwhile; ?>
        <a href="education_articles.php?group=adults" class="more-link">Смотреть все статьи →</a>
      <?php else: ?>
        <p>Пока нет статей для взрослых.</p>
      <?php endif; ?>
    </div>
    ...
    <div class="block">
      ...
      <?php if (mysqli_num_rows($videos) > 0): ?>
        ...
        <?php endwhile; ?>
        <a href="education_videos.php?group=adults" class="more-link">Смотреть все видео →</a>
      <?php else: ?>
        <p>Пока нет видео для взрослых.</p>
      <?php endif; ?>
    </div>
  </div>
</div>
