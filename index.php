...
if (!$news_result) {
    die("Ошибка запроса новостей: " . mysqli_error($connect));
}
...
if (!$events_result) {
    die("Ошибка запроса мероприятий: " . mysqli_error($connect));
}
?>
...
<main class="site-main">
    <div class="wrap grid-two">
        <div class="info-text">
            <strong>Центр</strong> — современная образовательная площадка, созданная для повышения финансовой грамотности...
        </div>
...
<div class="container3">
    <div class="question-answer">
        ...
        <div class="answer">Финансовая грамотность — это умение эффективно управлять своими доходами...</div>
    </div>
    <div class="question-answer">
        <div class="question">Какие услуги предоставляет центр финансового просвещения?</div>
        <div class="answer">Наш центр проводит образовательные курсы, семинары и консультации...</div>
    </div>
    <div class="question-answer">
        <div class="question">Кому будет полезно обращаться в центр?</div>
        <div class="answer">Центр открыт для всех желающих повысить уровень финансовой грамотности...</div>
    </div>
    <div class="question-answer">
        <div class="question">Нужно ли иметь какой-то опыт для участия в курсах?</div>
        <div class="answer">Нет, наши программы рассчитаны на разный уровень знаний...</div>
    </div>
    <div class="question-answer">
        <div class="question">Как записаться на обучение?</div>
        <div class="answer">Да, мы регулярно публикуем бесплатные статьи, видеоуроки и проводим открытые вебинары...</div>
    </div>
</div>
